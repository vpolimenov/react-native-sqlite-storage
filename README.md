...
dependencies {
    ...
    compile 'com.github.dryganets:sqlite-adapter-cipher:0.0.1'encription via sqlite cipher. Once litle-glue implementation of adapter will be ready it will be possible to remove android-native project and get rid of code duplication burden
}
```
